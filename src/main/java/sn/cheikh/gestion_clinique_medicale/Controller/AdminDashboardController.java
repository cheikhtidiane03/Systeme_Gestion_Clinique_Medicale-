...
public class AdminDashboardController implements Initializable {
    ...
    private void setActif(Button boutonActif) {
        Button[] tous = { btnDashboard, btnUtilisateurs, btnPatients,
                btnRendezVous, btnConsultations, btnFactures };
        for (Button btn : tous) {
    ...
    private void chargerStats() {
        try {
            ...
            lblNbConsultations.setText(String.valueOf(consultationService.getToutesConsultations().size()));
            lblNbFacturesNonPayees.setText(String.valueOf(factureService.getFacturesNonPayees().size()));
    ...
    @FXML private void afficherUtilisateurs()  { setActif(btnUtilisateurs);  chargerVue("admin/utilisateur-view.fxml",        "Utilisateurs"); }
    ...
    @FXML private void afficherConsultations() { setActif(btnConsultations); chargerVue("medecin/consultation-view.fxml",      "Consultations"); }
